...
public class YakinduSimplFormatter {
	...
	private static void populateVertexNames() {
		String[] values = {"on", "off", "flickering", "dim", "red", "blue", "green", "pink", "purple", "slow", "fast",
				...
				"loaded", "yellow", "white", "black", "adjusting time", "adjusting volume", "adjusting speed"};
