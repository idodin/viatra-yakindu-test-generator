...
public class YakinduSimplUtil {

	/**
	 * Load a Instance of the Yakindu Simplified Metamodel from the specified
	 * relative path.
	 * 
	...
	/**
	 * Save a Instance of the Yakindu Simplified Metamodel to the specified relative
	 * path
	 * 
	 ...
	 * path
	 * 
	 * @param root Root Statechart instance to serialize
	 * @param path to serialize to
	 * 
	 * @throws IOException if unable to serialize to file
	 */
	public static void saveModel(Statechart root, String path) throws IOException {
